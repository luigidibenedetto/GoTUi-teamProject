            ...
            <section className="content__highlights">
                ...
                <div>
                    <ul className="list">
                        ...
                        {activities.highlights.map((highlight) => <li className="list__row">
            ...
            <section className="content__container">
                ...
                <section className="content__fluid">
                    <section className="content__fluid__container">
                        ...
                        <div>
                            <ul className="list">
                                {activities.included.map((inclusion) => <li className="list__row">
                    ...
                    <div>
                        <div>
                            <input id="info" type="checkbox" className="readMore__trigger" />
                                <div className={infoVisible ? "readMore__info__text__visible" : "readMore__info__text__hidden"}>
                                    {activities.info}
                                    </div>
